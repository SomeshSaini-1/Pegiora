...
const Home = () => {
    ...
    const fetchCategory = async () => {
      try {
        const response = await axios.get(
          "https://redixpresslogistics.com/courier/public/api/pickup/get-category"
        );
  ...
  const handleSubmitMain = async (e) => {
    ...
    if (!pickup || !dropoff || !selectedCategory || !deliveryType) {
    ...
    try {
      ...
      const response = await fetch(
        `https://redixpresslogistics.com/courier/public/api/front/check-price?size_id=5&miles=${miles}`
      );
  ...
  return (
    <>
          ...
          <div className="row">
            <div className="col-md-6 col-lg-6 col-sm-12">
              <div className="shadow booking-delivery">
                <h1>Welcome to Pegiora Health!</h1>
                <p className="health-bdesc">
                  From medical prescriptions to lab reports, everything in
                  minutes
                </p>
                <Link
                ...
                <div className="health-bnr-img">
                  <img src="/image/red-health-bhome.png" alt="home banner" />
                </div>
            ...
            <div className="col-md-6 col-lg-6 col-sm-12">
              ...
              <div className="bg-white shadow bookingformhome">
                <h2 className="fw-bold">Medical Urgency? Book now</h2>
                    ...
                    <div className="date-time mb-3">
                      <div className="input-box">
                        ...
                        >
                          ...
                          {categories.non_medical.map((category) => (
                      ...
                      <div className="price-result mt-2">
                        <p>
                          ...
                          <span>
                            <b>
                              $
                              {priceResult.delivery_cost || "No price returned"}
                            </b>
                          </span>
                        </p>
                      </div>
          ...
          <div className="row">
            <div className="col-lg-6 col-md-6 col-sm-12 redhelth-inr">
              <div className="content-helth">
                ...
                <p data-aos="fade-up">
                  Do not worry, at Pegiora we do not disclose any form of
                  delivery from the beginning when its picked up to the
                  delivered time
                </p>
                <Link
                  to="https://redixpresslogistics.com/courier/public"
            ...
            <div className="col-lg-6 col-md-6 col-sm-12">
              <div className="image-container">
                <img src="/image/confid.png" alt="Medical Delivery" />
              </div>
            </div>
          </div>
        </div>
      ...
      {/* -----health specification --start--------------- */}
      <section className="home-health-speci">
        <div className="container">
          <div className="row">
            <div className="col-sm-12 col-md-6 col-lg-4">
              <div className="health-speci-limage">
                <img src="/image/health-speci-limge.png" alt="imageds" />
              </div>
            </div>
            <div className="col-sm-12 col-md-6 col-lg-8">
              <div className="spefic-predesc">
                <h3>Health cannot wait and that’s why you trust us</h3>
                <p>
                ...
                <div className="row hspecif-cardsIner">
                  <div
                    className="col-sm-12 col-md-6 col-lg-4 mb-4"
                  >
                    <div className="spefic-card">
                      <img src="/image/Confidentiality.png" alt="Pegiora service" />
                  ...
                  >
                    <div className="spefic-card">
                      <img src="/image/Accessibility.png" alt="Pegiora service" />
                      <h5>Accessibility</h5>
                      <p>Accessible health support to all background and areas.</p>
                    </div>
                  </div>
                  <div
                    className="col-sm-12 col-md-6 col-lg-4 mb-4"
                  >
                    <div className="spefic-card">
                      <img src="/image/Community.png" alt="Pegiora service" />
                      <h5>Community</h5>
